...
-- Author: Marcel Süess, ZHAW, sueesmar@students.zhaw.ch
-- Date: 02.01.2018
-- Version: 0.1
...
local pf_flag_extended = ProtoField.new("Extended Header Flag", "plus.flags.extended", ftypes.BOOLEAN, nil, 4, 0x01, "Latency sensitive when set.")
